...
export const JOB_TYPES = ['mkv_rip', 'raw_capture', 'ffv1_encode', 'h264_encode', 'hevc_encode', 'kodi_export'] as const
...
export const SETTING_CATEGORIES = ['general', 'encoding', 'kodi', 'paths', 'tools', 'rip'] as const
